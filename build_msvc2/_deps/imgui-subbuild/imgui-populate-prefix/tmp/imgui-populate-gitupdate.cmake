...
execute_process(
  COMMAND "C:/msys64/ucrt64/bin/git.exe" --git-dir=.git show-ref "master"
  WORKING_DIRECTORY "C:/Users/Cameron/game2/build_msvc2/_deps/imgui-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Cameron/game2/build_msvc2/_deps/imgui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Cameron/game2/build_msvc2/_deps/imgui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
